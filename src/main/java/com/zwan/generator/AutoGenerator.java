...
import com.zwan.generator.annotation.TableLogic;
import com.zwan.generator.annotation.TableName;
import com.zwan.generator.annotation.Version;
...
import com.zwan.generator.engine.AbstractTemplateEngine;
import com.zwan.generator.engine.VelocityTemplateEngine;
    ...
    protected ConfigBuilder pretreatmentConfigBuilder(ConfigBuilder config) {
        ...
        for (TableInfo tableInfo : tableList) {
            ...
            if (config.getGlobalConfig().isActiveRecord()) {
                // 开启 ActiveRecord 模式
                //tableInfo.setImportPackages(Model.class.getCanonicalName());  // modified by wan
            }
